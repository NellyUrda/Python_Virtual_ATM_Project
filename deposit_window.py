...
class AmountPage:
    def __init__(self, master):
        ...
        self.back_button = Button(master, text="Back", font=("Ariel", 10, 'bold'), bg="black", activebackground="black",
                                  fg="white", command=self.back)
        self.back_button.place(x=120, y=215, width=60, height=25)

    # OK button
    # the client enters the quantity he wishes to deposit
    ...
    def ok(self):
        try:
            ...
            current_balance = str(client.deposit_cash(amount))
            self.quantity_entry.delete(0, END)
            messagebox.showinfo(message="Quantity deposited successfully! ")
            ...
            messagebox.showinfo(message="Enter the quantity you wish to deposit.")
